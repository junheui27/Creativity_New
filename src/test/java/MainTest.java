...
class MainTest {
    ...
    @Test
    void isValidInputFileExistTrueTest()throws Exception{


        assertTrue(Main.isValidInputFileExistTrue("input.txt"));
        //assertTrue(Main.isValidInputFileExistTrue("inputt.txt"));
        //assertTrue(Main.isValidInputFileExistTrue("input .txt"));
    }
